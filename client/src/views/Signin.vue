            ...
            <v-card class="elevation-12">
              ...
              <v-card-text>                
                <v-form v-model="valid"> 
                  <v-text-field prepend-icon="person" name="login" label="Логин" type="text" @keyup.13="signin" required v-model="login" :rules="loginRooles"></v-text-field>
                  <v-text-field id="password" prepend-icon="lock" name="password" label="Пароль" type="password" @keyup.13="signin" v-model="pass" :rules="passRooles"></v-text-field>
                </v-form>
              </v-card-text>
              <v-card-actions>
                <v-spacer></v-spacer>
